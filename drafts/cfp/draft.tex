...
that $A_k(XY,UV)$ is true for each possible pair of predicates,
$A_i,A_j$, and every possible ordering of the variables $X,Y,U$ and
$V$ across $A_i$ and $A_j$. Finally, we define $S(XY)$ to be the
concatenation of the two arguments of $A_1(X,Y)$.
...
See Figures \ref{fig:parseexample}.
...
\begin{table}[t]
\begin{tabular}{>{\tiny} l >{\tiny} l >{\tiny} l}
\multicolumn{3}{>{\tiny}c}{$S$(X Y) $\leftarrow$ $A_1$(X, Y) : 1.0000} \\
\multicolumn{3}{>{\tiny}c}{$A_1$(X Y, U V) $\leftarrow$ $A_2$(X, U), $A_3$(V, Y) : 0.5002} \\
\multicolumn{3}{>{\tiny}c}{$A_1$(X Y, U V) $\leftarrow$ $A_3$(Y, V), $A_4$(X, U) : 0.3428} \\
\multicolumn{3}{>{\tiny}c}{$A_1$(X Y, U V) $\leftarrow$ $A_1$(V, Y), $A_4$(X, U) : 0.0796} \\
\multicolumn{3}{>{\tiny}c}{$A_1$(X Y, U V) $\leftarrow$ $A_1$(Y, V), $A_2$(X, U) : 0.0712} \\
\multicolumn{3}{>{\tiny}c}{$A_1$(X Y, U V) $\leftarrow$ $A_2$(Y, X), $A_3$(V, U) : 0.0021} \\
\multicolumn{3}{>{\tiny}c}{$A_1$(X Y, U V) $\leftarrow$ $A_1$(V, Y), $A_2$(X, U) : 0.0013} \\
\multicolumn{3}{>{\tiny}c}{$A_1$(X Y, U V) $\leftarrow$ $A_2$(V, X), $A_3$(Y, U) : 0.0008} \\
\multicolumn{3}{>{\tiny}c}{$A_1$(X Y, U V) $\leftarrow$ $A_1$(X, U), $A_2$(V, Y) : 0.0008} \\
\multicolumn{3}{>{\tiny}c}{$A_1$(X Y, U V) $\leftarrow$ $A_1$(X, U), $A_2$(Y, V) : 0.0008} \\
\multicolumn{3}{>{\tiny}c}{$A_1$(X Y, U V) $\leftarrow$ $A_1$(X, U), $A_4$(Y, V) : 0.0004} \\
$A_2$(before, comes) : 0.73 & $A_4$(after, comes) : 1.0  &
$A_3$(one, two) : 0.40 \\
$A_3$(two, three) : 0.21 &
$A_3$(three, four) : 0.11 &
$A_3$(four, five) : 0.07 \\
...
$A_3$(six, seven) : 0.04 \\
$A_3$(eight, nine) : 0.03 &
$A_3$(seven, eight) : 0.03 \\
$A_2$(fifty, fifty) : 0.04 &
$A_2$(thirty, thirty) : 0.04 \\
$A_2$(eighty, eighty) : 0.03 &
$A_3$(null, one) : 0.02 \\
$A_2$(forty, forty) : 0.03 &
$A_2$(twenty, twenty) : 0.03 \\
$A_2$(seventy, seventy) : 0.03 &
$A_2$(sixty, sixty) : 0.03 \\
$A_2$(ninety, ninety) : 0.03 &
$A_3$(eighteen, nineteen) : 0.01 \\
