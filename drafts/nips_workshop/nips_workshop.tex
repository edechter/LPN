...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.45\linewidth}
    ...
    \label{fig:heldoutLL}
  \end{subfigure}
  \caption{(\subref{tab:results}) Viterbi completions of held-out sentences for a 4-predicate 1-layer LPN. (\subref{fig:heldoutLL}) expected log likelihood on a set of held-out test data in a 35-predicate 5-layer LPN with.}
\end{figure}
