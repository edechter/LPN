...
:- expand_environment('$GIJOE_ROOT/experiments/prism/train_number_net_0004.log', P),
   set_ovbem_rec(logfile, P).

:- expand_environment('$GIJOE_ROOT/experiments/prism/train_number_net_0004.data', P),
