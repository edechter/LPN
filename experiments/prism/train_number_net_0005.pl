...
:- expand_environment('$GIJOE_ROOT/experiments/prism/train_number_net_0005.log', P),
   set_ovbem_rec(logfile, P).

:- expand_environment('$GIJOE_ROOT/experiments/prism/train_number_net_0005.data', P),
